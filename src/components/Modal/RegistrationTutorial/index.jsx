  ...
  return (
    <Tutorial onClick={() => setSelectType("registrarionForm")}>
      <HeadText>
        ...
        utilizar nossos serviços. Lá serão disponibilizados todos os nossos
        conteúdos para você! E você vai poder acessar sempre que quiser. É
        gratuíto e leva poucos minutinhos!
      </HeadText>
    </Tutorial>
  );
};
